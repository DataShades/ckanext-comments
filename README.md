...
**TODO:** Document any optional config settings here. For example:
	...
	# (optional, default: 24).
	ckanext.comments.some_setting = some_default_value
...
## Releasing a new version of ckanext-comments

If ckanext-comments should be available on PyPI you can follow these steps to publish a new version:
